...
CREATE TABLE IF NOT EXISTS `mydb`.`pedido` (
  ...
  INDEX `fk_pedido_funcionario1_idx` (`id_funcionário` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_pedido_funcionario1`
    ...
    REFERENCES `mydb`.`funcionario` (`id_funcionário`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`pagamento` (
  ...
  INDEX `fk_metodos_pagamento_pedido1_idx` (`id_pedido` ASC) VISIBLE,
  UNIQUE INDEX `id_metodos_pagamento_UNIQUE` (`id_pagamento` ASC) VISIBLE,
  INDEX `fk_pagamento_metodo_pagamento1_idx` (`id_metodo_pagamento` ASC) VISIBLE,
  CONSTRAINT `fk_metodos_pagamento_pedido1`
    FOREIGN KEY (`id_pedido`)
    REFERENCES `mydb`.`pedido` (`id_pedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
